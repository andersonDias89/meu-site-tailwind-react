...
export const Toggle = () => {
    ...
    return (
        <nav className='desk:hidden text-slate-200 absolute right-28 top-5'>
                    {!visibility === true &&
                    ...
                    {visibility === true &&
                        <ul className='z-50 w-full bg-transp fixed right-0 top-0 h-full transition-all flex flex-col item-center justify-center'>
                            <div className="">
                                <a className='text-slate-200 absolute right-28 top-5 text-2xl' onClick={() => setVisibility(false)}>X</a>
                            </div>
